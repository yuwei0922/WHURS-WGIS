        ...
        $.when($.ajax({
            ...
            switch ((yeardot - 1990) / 5 + 1) {
                case 1:
                    ...
                    yearresult1990.forEach(function (ele) {
                        name1 = ele.country_orig;
                        con1990 = ele.countryflow_1990
                        countryname1990.push(name1);
                        coun1990.push(con1990)
                    })
                    c = countryname1990.map((name, i) => ({
                        name,
                        value: coun1990[i]
                    }))
                    mapexcel(c)
                ...
                case 2:
                    ...
                    yearresult1995.forEach(function (ele) {
                        name1 = ele.country_orig;
                        con1995 = ele.countryflow_1995
                        countryname1995.push(name1)
                        coun1995.push(con1995)
                    })
                    c = countryname1995.map((name, i) => ({
                        name,
                        value: coun1995[i]
                    }))
                    mapexcel(c)
                ...
                case 3:
                    ...
                    yearresult2000.forEach(function (ele) {
                        name1 = ele.country_orig;
                        con2000 = ele.countryflow_2000
                        countryname2000.push(name1)
                        coun2000.push(con2000)
                    })
                    c = countryname2000.map((name, i) => ({
                        name,
                        value: coun2000[i]
                    }))
                    mapexcel(c)
                ...
                case 4:
                    ...
                    yearresult2005.forEach(function (ele) {
                        name1 = ele.country_orig;
                        con2005 = ele.countryflow_2005
                        countryname2005.push(name1)
                        coun2005.push(con2005)
                    })
                    c = countryname2005.map((name, i) => ({
                        name,
                        value: coun2005[i]
                    }))
                    mapexcel(c)
            ...
            resultsum.forEach(function (ele) {
                name1 = ele.country_orig;
                countrynamesum.push(name1);
                con1990 = ele.countryflow_1990
                con1995 = ele.countryflow_1995
                con2000 = ele.countryflow_2000
                con2005 = ele.countryflow_2005
                consum=con1990+con1995+con2000+con2005
                counsum.push(consum)
            })
        })
    } else {
