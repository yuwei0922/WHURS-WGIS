...
function newchart(ori1,ori2,ori3,data1,data2,data3){
    ...
    pietablebody[1].innerHTML=data1
    pietablebody[2].innerHTML=data2
    pietablebody[3].innerHTML=data3
    pietablehead[1].innerHTML=ori1
    pietablehead[2].innerHTML=ori2
    pietablehead[3].innerHTML=ori3
}                    
let con = ''
let result = []
//获取伪元素
