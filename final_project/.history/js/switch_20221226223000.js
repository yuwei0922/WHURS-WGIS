            ...
            if (beforecontent == '"入"') {
                ...
                $.when($.ajax({
                        ...
                        new Chart(document.getElementById("chartjs-dashboard-pie"), {
                            type: 'pie',
                            data: {
                                labels: [pieyear[0].country_orig, pieyear[1].country_orig, pieyear[2].country_orig],
                                datasets: [{
                                    data: [pieyear[0].countryflow_1990, pieyear[1].countryflow_1990, pieyear[2].countryflow_1990],
                                    backgroundColor: [
